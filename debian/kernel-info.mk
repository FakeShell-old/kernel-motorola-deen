...
# Kernel base version
KERNEL_BASE_VERSION = 3.18-21

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci androidboot.usbconfigfs=true loop.max_part=7 androidboot.veritymode=eio androidboot.selinux=permissive buildvariant=userdebug
...
KERNEL_BOOTIMAGE_KERNEL_OFFSET = 0x80008000
KERNEL_BOOTIMAGE_INITRAMFS_OFFSET = 0x81000000
KERNEL_BOOTIMAGE_SECONDIMAGE_OFFSET = 0x80f00000
